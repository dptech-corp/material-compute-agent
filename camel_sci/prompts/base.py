...
from camel_sci.interpreters import BaseInterpreter, SubprocessInterpreter
from camel_sci.types import RoleType
from camel_sci.utils import get_system_information
...
class TextPrompt(str):
    ...
    def key_words(self) -> Set[str]:
        ...
        from camel_sci.utils import get_prompt_template_key_words
