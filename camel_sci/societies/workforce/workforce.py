...
from camel_sci.configs import ChatGPTConfig
from camel_sci.messages.base import BaseMessage
from camel_sci.models import ModelFactory
from camel_sci.societies.workforce.base import BaseNode
from camel_sci.societies.workforce.prompts import (
    ASSIGN_TASK_PROMPT,
    CREATE_NODE_PROMPT,
    WF_TASK_DECOMPOSE_PROMPT,
)
from camel_sci.societies.workforce.role_playing_worker import RolePlayingWorker
from camel_sci.societies.workforce.single_agent_worker import SingleAgentWorker
from camel_sci.societies.workforce.task_channel import TaskChannel
from camel_sci.societies.workforce.utils import (
    TaskAssignResult,
    WorkerConf,
    check_if_running,
)
from camel_sci.societies.workforce.worker import Worker
from camel_sci.tasks.task import Task, TaskState
from camel_sci.toolkits import GoogleMapsToolkit, SearchToolkit, WeatherToolkit
...
class Workforce(BaseNode):
    ...
    def __init__(
        ...
        task_sys_msg = BaseMessage.make_assistant_message(
            ...
            content="You are going to compose and decompose tasks and after that, you must talk with human to get the feedback.",
        )
